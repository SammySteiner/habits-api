...
gym_goal_repeat = Goal.create(interval: 1, expiration: Date.tomorrow(), plan_id: 1, start_date: Date.today())
...
marathon_goal_4 = Goal.create(expiration: marathon_goal_3.expiration.tomorrow(), plan_id: 3, interval: 1, start_date: Date.today())
